...
$mysqli=mysqli_connect('localhost','Tinkita','Tinkita2025','visiteurs');//'serveur','nom d'utilisateur','pass','nom de la base'
if(!$mysqli) {
...
<html>
    ...
    <body>
        <h1>Espace membre</h1>
        Pour modifier vos informations, <a href="espace_membre.php?modifier">cliquez ici</a>
        <br>
        Pour supprimer votre compte, <a href="espace_membre.php?supprimer">cliquez ici</a>
        <br>
